...
function validar()
{
	...
	$("[obrigatorio=sim]").each( function() {
		...
		{
			// conta quantos radio estão checked, que possuem name iguais
		...
		{
			// conta quantos checkbox estão checked, que possuem grp_check iguais
		...
		if( $(this).val().trim() == "" )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve ser preenchido !";
			erros++; 
		}
		else
		if( $(this).attr("tipo_info") == "cpf" && !validaCPF($(this).val().trim()) )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve conter um CPF válido !";
			erros++; 
		}
		else
		if( $(this).attr("tipo_info") == "email" && !ValidaEmail($(this).val().trim()) )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve conter E-mail válido !";
			erros++;
		}		
		else
		if( $(this).attr("tipo_info") == "inteiro" && !numInteiro($(this).val().trim()) )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve conter um número inteiro válido !";
			erros++; 
		}		
		else
		if( $(this).attr("tipo_info") == "real" && !numReal($(this).val().trim()) )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve conter um número real válido !";
			erros++; 
		}		
		else
		if( $(this).attr("tipo_info") == "data" && !verificaData($(this).val().trim()) )
		{
			msg = "O campo " +  $(this).attr("rotulo") + " deve conter uma data válida !";
			erros++; 
		}		
		
		if( msg != "" )
		{
			var div = $("#msg_erro_" + $(this).attr("name"));
			if( div )
			{
				div.html( msg );
			}			
